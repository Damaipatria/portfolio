...
export default function Home() {
  return (
    <main>
      ...
      <section id="tentang" className="flex md:flex-row flex-col justify-center 2xl:gap-24 lg:gap-5 md:gap-3 py-20 lg:px-0 md:px-5 px-2 font-quicksand bg-gray-50">
